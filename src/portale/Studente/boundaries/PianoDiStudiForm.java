...
import portale.Studente.controls.IscrizioneEsameCtrl;
...
public class PianoDiStudiForm {
    ...
    public void fillAppelli(DisplayPianoDiStudi materia) {
        ...
        ObservableList<DisplayAppello> appelli = mIscrizioneEsameCtrl.getAppelli(materia.getCodiceMateria());
    ...
    public void insertPrenotazione(String appello, String matricola) {
        ...
        mIscrizioneEsameCtrl.insertPrenotazione(matricola, appello);
        appelliTV.getColumns().clear();
